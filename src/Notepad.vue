    <template>
        <div>
          ...
          <div id="centre">
            ...
            <ul id="myUL">
              <li v-for="(item, index) in array" v-bind:class="{checked: isChecked[index]}">
                <h3 class="items" v-on:click="ToggleClass(index)">{{item}}</h3>
                <span class="close" v-on:click="RemoveElement(index)">×</span>
              </li>
            </ul>
          </div>
        </div>
